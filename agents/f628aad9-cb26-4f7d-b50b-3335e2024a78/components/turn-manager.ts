/**
 * Turn Manager - HR Assistant Tester
 * 
...
export class HRAssistantTesterTurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): HRAssistantTesterTurnManager {
  return new HRAssistantTesterTurnManager();
}
