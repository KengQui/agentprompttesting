/**
 * Flow Controller - HR Assistant Tester
 * 
...
export class HRAssistantTesterFlowController extends BaseFlowController {
  constructor() {
    super(CONFIG);
  }
}

export function createFlowController(): HRAssistantTesterFlowController {
  return new HRAssistantTesterFlowController();
}
