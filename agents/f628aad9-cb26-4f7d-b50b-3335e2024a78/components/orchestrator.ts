/**
 * Orchestrator - HR Assistant Tester
 * 
...
import { HRAssistantTesterTurnManager } from './turn-manager';
import { HRAssistantTesterFlowController } from './flow-controller';
import type { ClassificationResult, TurnResult, AgentConfig } from '../../../server/components/types';

export class HRAssistantTesterOrchestrator extends BaseOrchestrator {
  constructor(agentConfig: AgentConfig) {
    ...
    this.turnManager = new HRAssistantTesterTurnManager();
    this.flowController = new HRAssistantTesterFlowController();
  }
...
export function createOrchestrator(agentConfig: AgentConfig): HRAssistantTesterOrchestrator {
  return new HRAssistantTesterOrchestrator(agentConfig);
}
