...
import { Test1TurnManager } from './turn-manager';
import { Test1FlowController } from './flow-controller';
import type { ClassificationResult, TurnResult, AgentConfig } from '../../../server/components/types';

export class Test1Orchestrator extends BaseOrchestrator {
  constructor(agentConfig: AgentConfig) {
    ...
    this.turnManager = new Test1TurnManager();
    this.flowController = new Test1FlowController();
  }
...
export function createOrchestrator(agentConfig: AgentConfig): Test1Orchestrator {
  return new Test1Orchestrator(agentConfig);
}
