/**
 * Turn Manager - Action Test Agent Oab5V1
 * 
...
export class ActionTestAgentOab5V1TurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): ActionTestAgentOab5V1TurnManager {
  return new ActionTestAgentOab5V1TurnManager();
}
