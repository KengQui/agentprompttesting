/**
 * Flow Controller - Draft-Agent-TnqJh7
 * 
...
export class DraftAgentTnqJh7FlowController extends BaseFlowController {
  constructor() {
    super(CONFIG);
  }
}

export function createFlowController(): DraftAgentTnqJh7FlowController {
  return new DraftAgentTnqJh7FlowController();
}
