/**
 * Turn Manager - Draft-Agent-TnqJh7
 * 
...
export class DraftAgentTnqJh7TurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): DraftAgentTnqJh7TurnManager {
  return new DraftAgentTnqJh7TurnManager();
}
