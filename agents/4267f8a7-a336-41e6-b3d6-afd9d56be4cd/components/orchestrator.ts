...
import { TestFlowAgentTurnManager } from './turn-manager';
import { TestFlowAgentFlowController } from './flow-controller';
import type { ClassificationResult, TurnResult, AgentConfig } from '../../../server/components/types';

export class TestFlowAgentOrchestrator extends BaseOrchestrator {
  constructor(agentConfig: AgentConfig) {
    ...
    this.turnManager = new TestFlowAgentTurnManager();
    this.flowController = new TestFlowAgentFlowController();
  }
...
export function createOrchestrator(agentConfig: AgentConfig): TestFlowAgentOrchestrator {
  return new TestFlowAgentOrchestrator(agentConfig);
}
