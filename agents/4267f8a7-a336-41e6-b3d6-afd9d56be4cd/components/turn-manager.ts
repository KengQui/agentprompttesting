...
export class TestFlowAgentTurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): TestFlowAgentTurnManager {
  return new TestFlowAgentTurnManager();
}
