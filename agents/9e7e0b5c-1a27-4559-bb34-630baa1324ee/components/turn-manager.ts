/**
 * Turn Manager - Payroll Assistant
 * 
...
export class PayrollAssistantTurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): PayrollAssistantTurnManager {
  return new PayrollAssistantTurnManager();
}
