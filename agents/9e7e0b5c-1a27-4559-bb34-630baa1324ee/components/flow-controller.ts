/**
 * Flow Controller - Payroll Assistant
 * 
...
export class PayrollAssistantFlowController extends BaseFlowController {
  constructor() {
    super(CONFIG);
  }
}

export function createFlowController(): PayrollAssistantFlowController {
  return new PayrollAssistantFlowController();
}
