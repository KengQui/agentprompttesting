/**
 * Turn Manager - Call-In Shift Agent
 * 
...
export class CallInShiftAgentTurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): CallInShiftAgentTurnManager {
  return new CallInShiftAgentTurnManager();
}
