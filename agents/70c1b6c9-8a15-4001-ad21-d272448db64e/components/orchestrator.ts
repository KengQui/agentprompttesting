/**
 * Orchestrator - Call-In Shift Agent
 * 
...
import { CallInShiftAgentTurnManager } from './turn-manager';
import { CallInShiftAgentFlowController } from './flow-controller';
import type { ClassificationResult, TurnResult, AgentConfig } from '../../../server/components/types';

export class CallInShiftAgentOrchestrator extends BaseOrchestrator {
  constructor(agentConfig: AgentConfig) {
    ...
    this.turnManager = new CallInShiftAgentTurnManager();
    this.flowController = new CallInShiftAgentFlowController();
  }
...
export function createOrchestrator(agentConfig: AgentConfig): CallInShiftAgentOrchestrator {
  return new CallInShiftAgentOrchestrator(agentConfig);
}
