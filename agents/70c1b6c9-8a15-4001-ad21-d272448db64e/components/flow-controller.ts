/**
 * Flow Controller - Call-In Shift Agent
 * 
...
export class CallInShiftAgentFlowController extends BaseFlowController {
  constructor() {
    super(CONFIG);
  }
}

export function createFlowController(): CallInShiftAgentFlowController {
  return new CallInShiftAgentFlowController();
}
