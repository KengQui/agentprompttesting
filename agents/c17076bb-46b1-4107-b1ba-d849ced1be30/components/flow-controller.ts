/**
 * Flow Controller - Call-In Test Agent
 * 
...
export class CallInTestAgentFlowController extends BaseFlowController {
  constructor() {
    super(CONFIG);
  }
}

export function createFlowController(): CallInTestAgentFlowController {
  return new CallInTestAgentFlowController();
}
