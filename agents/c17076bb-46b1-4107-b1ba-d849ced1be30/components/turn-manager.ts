/**
 * Turn Manager - Call-In Test Agent
 * 
...
export class CallInTestAgentTurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): CallInTestAgentTurnManager {
  return new CallInTestAgentTurnManager();
}
