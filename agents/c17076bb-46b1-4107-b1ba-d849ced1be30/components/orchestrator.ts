/**
 * Orchestrator - Call-In Test Agent
 * 
...
import { CallInTestAgentTurnManager } from './turn-manager';
import { CallInTestAgentFlowController } from './flow-controller';
import type { ClassificationResult, TurnResult, AgentConfig } from '../../../server/components/types';

export class CallInTestAgentOrchestrator extends BaseOrchestrator {
  constructor(agentConfig: AgentConfig) {
    ...
    this.turnManager = new CallInTestAgentTurnManager();
    this.flowController = new CallInTestAgentFlowController();
  }
...
export function createOrchestrator(agentConfig: AgentConfig): CallInTestAgentOrchestrator {
  return new CallInTestAgentOrchestrator(agentConfig);
}
