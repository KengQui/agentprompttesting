/**
 * Turn Manager - HCM Expression Builder Test
 * 
...
export class HCMExpressionBuilderTestTurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): HCMExpressionBuilderTestTurnManager {
  return new HCMExpressionBuilderTestTurnManager();
}
