/**
 * Flow Controller - HCM Expression Builder Test
 * 
...
export class HCMExpressionBuilderTestFlowController extends BaseFlowController {
  constructor() {
    super(CONFIG);
  }
}

export function createFlowController(): HCMExpressionBuilderTestFlowController {
  return new HCMExpressionBuilderTestFlowController();
}
