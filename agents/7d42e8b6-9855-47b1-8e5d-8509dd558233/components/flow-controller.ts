/**
 * Flow Controller - Change address
 * 
...
export class ChangeaddressFlowController extends BaseFlowController {
  constructor() {
    super(CONFIG);
  }
}

export function createFlowController(): ChangeaddressFlowController {
  return new ChangeaddressFlowController();
}
