...
export class ShiftmanagerKQTurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): ShiftmanagerKQTurnManager {
  return new ShiftmanagerKQTurnManager();
}
