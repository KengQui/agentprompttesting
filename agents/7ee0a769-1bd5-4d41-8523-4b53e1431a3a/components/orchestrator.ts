...
import { ShiftmanagerKQTurnManager } from './turn-manager';
import { ShiftmanagerKQFlowController } from './flow-controller';
import type { ClassificationResult, TurnResult, AgentConfig } from '../../../server/components/types';

export class ShiftmanagerKQOrchestrator extends BaseOrchestrator {
  constructor(agentConfig: AgentConfig) {
    ...
    this.turnManager = new ShiftmanagerKQTurnManager();
    this.flowController = new ShiftmanagerKQFlowController();
  }
...
export function createOrchestrator(agentConfig: AgentConfig): ShiftmanagerKQOrchestrator {
  return new ShiftmanagerKQOrchestrator(agentConfig);
}
