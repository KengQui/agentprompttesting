/**
 * Flow Controller - shift manager KQ
 * 
...
export class ShiftmanagerKQFlowController extends BaseFlowController {
  constructor() {
    super(CONFIG);
  }
}

export function createFlowController(): ShiftmanagerKQFlowController {
  return new ShiftmanagerKQFlowController();
}
