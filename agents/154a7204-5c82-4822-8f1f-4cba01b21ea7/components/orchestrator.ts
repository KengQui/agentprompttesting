/**
 * Orchestrator - Test Agent for Clone
 * 
...
import { TestAgentforCloneTurnManager } from './turn-manager';
import { TestAgentforCloneFlowController } from './flow-controller';
import type { ClassificationResult, TurnResult, AgentConfig } from '../../../server/components/types';

export class TestAgentforCloneOrchestrator extends BaseOrchestrator {
  constructor(agentConfig: AgentConfig) {
    ...
    this.turnManager = new TestAgentforCloneTurnManager();
    this.flowController = new TestAgentforCloneFlowController();
  }
...
export function createOrchestrator(agentConfig: AgentConfig): TestAgentforCloneOrchestrator {
  return new TestAgentforCloneOrchestrator(agentConfig);
}
