/**
 * Flow Controller - Test Agent for Clone
 * 
...
export class TestAgentforCloneFlowController extends BaseFlowController {
  constructor() {
    super(CONFIG);
  }
}

export function createFlowController(): TestAgentforCloneFlowController {
  return new TestAgentforCloneFlowController();
}
