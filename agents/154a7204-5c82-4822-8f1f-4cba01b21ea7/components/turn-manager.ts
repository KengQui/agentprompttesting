/**
 * Turn Manager - Test Agent for Clone
 * 
...
export class TestAgentforCloneTurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): TestAgentforCloneTurnManager {
  return new TestAgentforCloneTurnManager();
}
