...
export class Lifeevent5TurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): Lifeevent5TurnManager {
  return new Lifeevent5TurnManager();
}
