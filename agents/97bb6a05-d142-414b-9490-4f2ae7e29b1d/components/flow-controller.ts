...
export class Lifeevent5FlowController extends BaseFlowController {
  constructor() {
    super(CONFIG);
  }
}

export function createFlowController(): Lifeevent5FlowController {
  return new Lifeevent5FlowController();
}
