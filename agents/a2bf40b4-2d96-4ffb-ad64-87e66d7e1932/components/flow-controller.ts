/**
 * Flow Controller - Pay check - Payroll Assistant
 * 
...
export class PaycheckPayrollAssistantFlowController extends BaseFlowController {
  constructor() {
    super(CONFIG);
  }
}

export function createFlowController(): PaycheckPayrollAssistantFlowController {
  return new PaycheckPayrollAssistantFlowController();
}
