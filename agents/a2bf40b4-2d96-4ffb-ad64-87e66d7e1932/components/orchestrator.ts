...
import { PaycheckPayrollAssistantTurnManager } from './turn-manager';
import { PaycheckPayrollAssistantFlowController } from './flow-controller';
...
export class PaycheckPayrollAssistantOrchestrator extends BaseOrchestrator {
  constructor(agentConfig: AgentConfig) {
    ...
    this.turnManager = new PaycheckPayrollAssistantTurnManager();
    this.flowController = new PaycheckPayrollAssistantFlowController();
  }
