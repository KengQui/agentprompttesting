/**
 * Turn Manager - Pay check - Payroll Assistant
 * 
...
export class PaycheckPayrollAssistantTurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): PaycheckPayrollAssistantTurnManager {
  return new PaycheckPayrollAssistantTurnManager();
}
