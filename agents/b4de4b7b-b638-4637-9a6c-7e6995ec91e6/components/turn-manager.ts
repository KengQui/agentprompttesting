...
export class PersonalSSTurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): PersonalSSTurnManager {
  return new PersonalSSTurnManager();
}
