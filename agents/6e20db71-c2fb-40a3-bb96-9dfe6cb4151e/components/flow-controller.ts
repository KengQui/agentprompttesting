...
export class TestAgentFlowController extends BaseFlowController {
  constructor() {
    super(CONFIG);
  }
}

export function createFlowController(): TestAgentFlowController {
  return new TestAgentFlowController();
}
