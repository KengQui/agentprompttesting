...
export class LifeEventAgentTurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): LifeEventAgentTurnManager {
  return new LifeEventAgentTurnManager();
}
