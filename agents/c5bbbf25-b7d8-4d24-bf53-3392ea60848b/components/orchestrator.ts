/**
 * Orchestrator - Settings Test Agent
 * 
...
import { SettingsTestAgentTurnManager } from './turn-manager';
import { SettingsTestAgentFlowController } from './flow-controller';
import type { ClassificationResult, TurnResult, AgentConfig } from '../../../server/components/types';

export class SettingsTestAgentOrchestrator extends BaseOrchestrator {
  constructor(agentConfig: AgentConfig) {
    ...
    this.turnManager = new SettingsTestAgentTurnManager();
    this.flowController = new SettingsTestAgentFlowController();
  }
...
export function createOrchestrator(agentConfig: AgentConfig): SettingsTestAgentOrchestrator {
  return new SettingsTestAgentOrchestrator(agentConfig);
}
