/**
 * Turn Manager - Settings Test Agent
 * 
...
export class SettingsTestAgentTurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): SettingsTestAgentTurnManager {
  return new SettingsTestAgentTurnManager();
}
