/**
 * Flow Controller - Settings Test Agent
 * 
...
export class SettingsTestAgentFlowController extends BaseFlowController {
  constructor() {
    super(CONFIG);
  }
}

export function createFlowController(): SettingsTestAgentFlowController {
  return new SettingsTestAgentFlowController();
}
