/**
 * Flow Controller - FlowTestAgent_MbZOxj
 * 
...
export class FlowTestAgentMbZOxjFlowController extends BaseFlowController {
  constructor() {
    super(CONFIG);
  }
}

export function createFlowController(): FlowTestAgentMbZOxjFlowController {
  return new FlowTestAgentMbZOxjFlowController();
}
