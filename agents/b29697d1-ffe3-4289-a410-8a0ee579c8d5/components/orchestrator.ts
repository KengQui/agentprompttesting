/**
 * Orchestrator - FlowTestAgent_MbZOxj
 * 
...
import { FlowTestAgentMbZOxjTurnManager } from './turn-manager';
import { FlowTestAgentMbZOxjFlowController } from './flow-controller';
import type { ClassificationResult, TurnResult, AgentConfig } from '../../../server/components/types';

export class FlowTestAgentMbZOxjOrchestrator extends BaseOrchestrator {
  constructor(agentConfig: AgentConfig) {
    ...
    this.turnManager = new FlowTestAgentMbZOxjTurnManager();
    this.flowController = new FlowTestAgentMbZOxjFlowController();
  }
...
export function createOrchestrator(agentConfig: AgentConfig): FlowTestAgentMbZOxjOrchestrator {
  return new FlowTestAgentMbZOxjOrchestrator(agentConfig);
}
