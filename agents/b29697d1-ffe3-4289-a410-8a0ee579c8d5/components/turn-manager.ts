/**
 * Turn Manager - FlowTestAgent_MbZOxj
 * 
...
export class FlowTestAgentMbZOxjTurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): FlowTestAgentMbZOxjTurnManager {
  return new FlowTestAgentMbZOxjTurnManager();
}
