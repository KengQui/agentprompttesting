/**
 * Turn Manager - MultiFile Test Agent ypCl2E
 * 
...
export class MultiFileTestAgentypCl2ETurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): MultiFileTestAgentypCl2ETurnManager {
  return new MultiFileTestAgentypCl2ETurnManager();
}
