/**
 * Flow Controller - SampleDataTestAgent_Ogg69Q
 * 
...
export class SampleDataTestAgentOgg69QFlowController extends BaseFlowController {
  constructor() {
    super(CONFIG);
  }
}

export function createFlowController(): SampleDataTestAgentOgg69QFlowController {
  return new SampleDataTestAgentOgg69QFlowController();
}
