/**
 * Turn Manager - SampleDataTestAgent_Ogg69Q
 * 
...
export class SampleDataTestAgentOgg69QTurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): SampleDataTestAgentOgg69QTurnManager {
  return new SampleDataTestAgentOgg69QTurnManager();
}
