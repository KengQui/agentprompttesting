...
import { InferTest0KRXVXTurnManager } from './turn-manager';
import { InferTest0KRXVXFlowController } from './flow-controller';
import type { ClassificationResult, TurnResult, AgentConfig } from '../../../server/components/types';

export class InferTest0KRXVXOrchestrator extends BaseOrchestrator {
  constructor(agentConfig: AgentConfig) {
    ...
    this.turnManager = new InferTest0KRXVXTurnManager();
    this.flowController = new InferTest0KRXVXFlowController();
  }
...
export function createOrchestrator(agentConfig: AgentConfig): InferTest0KRXVXOrchestrator {
  return new InferTest0KRXVXOrchestrator(agentConfig);
}
