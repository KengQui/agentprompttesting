...
export class InferTest0KRXVXTurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): InferTest0KRXVXTurnManager {
  return new InferTest0KRXVXTurnManager();
}
