/**
 * Flow Controller - InferTest_0KRXVX
 * 
...
export class InferTest0KRXVXFlowController extends BaseFlowController {
  constructor() {
    super(CONFIG);
  }
}

export function createFlowController(): InferTest0KRXVXFlowController {
  return new InferTest0KRXVXFlowController();
}
