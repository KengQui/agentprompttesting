/**
 * Turn Manager - DomainKnowledgeTestAgent
 * 
...
export class DomainKnowledgeTestAgentTurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): DomainKnowledgeTestAgentTurnManager {
  return new DomainKnowledgeTestAgentTurnManager();
}
