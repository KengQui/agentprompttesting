/**
 * Flow Controller - DomainKnowledgeTestAgent
 * 
...
export class DomainKnowledgeTestAgentFlowController extends BaseFlowController {
  constructor() {
    super(CONFIG);
  }
}

export function createFlowController(): DomainKnowledgeTestAgentFlowController {
  return new DomainKnowledgeTestAgentFlowController();
}
