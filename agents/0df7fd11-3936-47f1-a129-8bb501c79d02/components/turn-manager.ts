/**
 * Turn Manager - HCM Report Custom Column Builder
 * 
...
export class HCMReportCustomColumnBuilderTurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): HCMReportCustomColumnBuilderTurnManager {
  return new HCMReportCustomColumnBuilderTurnManager();
}
