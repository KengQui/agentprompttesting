/**
 * Orchestrator - HCM Report Custom Column Builder
 * 
...
import { HCMReportCustomColumnBuilderTurnManager } from './turn-manager';
import { HCMReportCustomColumnBuilderFlowController } from './flow-controller';
import type { ClassificationResult, TurnResult, AgentConfig } from '../../../server/components/types';

export class HCMReportCustomColumnBuilderOrchestrator extends BaseOrchestrator {
  constructor(agentConfig: AgentConfig) {
    ...
    this.turnManager = new HCMReportCustomColumnBuilderTurnManager();
    this.flowController = new HCMReportCustomColumnBuilderFlowController();
  }
...
export function createOrchestrator(agentConfig: AgentConfig): HCMReportCustomColumnBuilderOrchestrator {
  return new HCMReportCustomColumnBuilderOrchestrator(agentConfig);
}
