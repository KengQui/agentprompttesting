/**
 * Flow Controller - HCM Report Custom Column Builder
 * 
...
export class HCMReportCustomColumnBuilderFlowController extends BaseFlowController {
  constructor() {
    super(CONFIG);
  }
}

export function createFlowController(): HCMReportCustomColumnBuilderFlowController {
  return new HCMReportCustomColumnBuilderFlowController();
}
