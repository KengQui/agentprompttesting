/**
 * Orchestrator - Vacation Manager Test
 * 
...
import { VacationManagerTestTurnManager } from './turn-manager';
import { VacationManagerTestFlowController } from './flow-controller';
import type { ClassificationResult, TurnResult, AgentConfig } from '../../../server/components/types';

export class VacationManagerTestOrchestrator extends BaseOrchestrator {
  constructor(agentConfig: AgentConfig) {
    ...
    this.turnManager = new VacationManagerTestTurnManager();
    this.flowController = new VacationManagerTestFlowController();
  }
...
export function createOrchestrator(agentConfig: AgentConfig): VacationManagerTestOrchestrator {
  return new VacationManagerTestOrchestrator(agentConfig);
}
