/**
 * Flow Controller - Vacation Manager Test
 * 
...
export class VacationManagerTestFlowController extends BaseFlowController {
  constructor() {
    super(CONFIG);
  }
}

export function createFlowController(): VacationManagerTestFlowController {
  return new VacationManagerTestFlowController();
}
