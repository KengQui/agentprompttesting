/**
 * Turn Manager - Vacation Manager Test
 * 
...
export class VacationManagerTestTurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): VacationManagerTestTurnManager {
  return new VacationManagerTestTurnManager();
}
