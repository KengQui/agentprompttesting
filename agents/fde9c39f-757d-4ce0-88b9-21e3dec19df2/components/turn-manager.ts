...
export class Lifeevent4TurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): Lifeevent4TurnManager {
  return new Lifeevent4TurnManager();
}
