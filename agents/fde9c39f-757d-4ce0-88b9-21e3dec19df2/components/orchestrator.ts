...
import { Lifeevent4TurnManager } from './turn-manager';
import { Lifeevent4FlowController } from './flow-controller';
...
export class Lifeevent4Orchestrator extends BaseOrchestrator {
  constructor(agentConfig: AgentConfig) {
    ...
    this.turnManager = new Lifeevent4TurnManager();
    this.flowController = new Lifeevent4FlowController();
  }
