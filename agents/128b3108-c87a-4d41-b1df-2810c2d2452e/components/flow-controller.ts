/**
 * Flow Controller - PromptStyleTestAgent
 * 
...
export class PromptStyleTestAgentFlowController extends BaseFlowController {
  constructor() {
    super(CONFIG);
  }
}

export function createFlowController(): PromptStyleTestAgentFlowController {
  return new PromptStyleTestAgentFlowController();
}
