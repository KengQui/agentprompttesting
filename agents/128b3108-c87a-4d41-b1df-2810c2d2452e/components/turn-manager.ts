/**
 * Turn Manager - PromptStyleTestAgent
 * 
...
export class PromptStyleTestAgentTurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): PromptStyleTestAgentTurnManager {
  return new PromptStyleTestAgentTurnManager();
}
