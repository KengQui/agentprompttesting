...
export class Lifeevent2TurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): Lifeevent2TurnManager {
  return new Lifeevent2TurnManager();
}
