...
import { Lifeevent2TurnManager } from './turn-manager';
import { Lifeevent2FlowController } from './flow-controller';
...
export class Lifeevent2Orchestrator extends BaseOrchestrator {
  constructor(agentConfig: AgentConfig) {
    ...
    this.turnManager = new Lifeevent2TurnManager();
    this.flowController = new Lifeevent2FlowController();
  }
