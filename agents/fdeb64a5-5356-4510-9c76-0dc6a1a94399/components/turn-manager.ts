/**
 * Turn Manager - Copy of Test Agent for Clone
 * 
...
export class CopyofTestAgentforCloneTurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): CopyofTestAgentforCloneTurnManager {
  return new CopyofTestAgentforCloneTurnManager();
}
