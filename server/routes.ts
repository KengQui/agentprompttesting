        ...
        detectedIntent = turnResult.intent;
          ...
          if (turnResult.nextAction !== 'generate_ai_response') {
            ...
            const suggestedActionPrefixes: Record<string, string> = {
              ...
              'Breakdown in details (S)': '[SYSTEM CONTEXT: The user clicked "Breakdown in details (S)". Provide a concise structural breakdown of the most recent expression. Use EXACTLY this format:\n\n**Expression:**\n<the full expression on its own line>\n\n**Step-by-Step:**\n1. <sub-expression>\n2. <sub-expression>\n... (list the key sub-expressions as separate steps)\nN-1. <composition using [Step N] references, e.g. If([Step 1],[Step 2],[Step 3])>\nN. *Final:* <the full expression>\n\nRules:\n- List each distinct sub-expression or argument on its own numbered line — just the expression, NO annotation or explanation.\n- Do NOT add → lines or plain-language explanations after any step.\n- Group related parts at a higher level — do NOT break trivial literals like commas or single strings into their own steps unless they are meaningful arguments.\n- Use [Step N] references in a composition step to show how the parts fit together.\n- The Final step shows the complete expression reassembled. No annotation after Final either.\n- Do NOT include any additional headers or commentary beyond Expression and Step-by-Step.\n- Do NOT use code fences or markdown code blocks.]\n\n',
