...
export class {{CLASS_NAME}}TurnManager extends BaseTurnManager {
  constructor() {
    super(CONFIG);
  }
}

export function createTurnManager(): {{CLASS_NAME}}TurnManager {
  return new {{CLASS_NAME}}TurnManager();
}
