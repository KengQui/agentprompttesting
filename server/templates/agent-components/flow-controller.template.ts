...
export class {{CLASS_NAME}}FlowController extends BaseFlowController {
  constructor() {
    super(CONFIG);
  }
}

export function createFlowController(): {{CLASS_NAME}}FlowController {
  return new {{CLASS_NAME}}FlowController();
}
